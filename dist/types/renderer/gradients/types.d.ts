...
export type GradientConstructorMap = Record<GradientType, (p: p5, fontManager: P5AsciifyFontManager, shader: p5.Shader, characters: string, brightnessStart: number, brightnessEnd: number, params: any) => P5AsciifyGradient>;
