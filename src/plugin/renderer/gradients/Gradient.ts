import p5 from 'p5';
import { P5AsciifyColorPalette, P5AsciifyFontManager, P5AsciifyError } from 'p5.asciify';
...
export abstract class P5AsciifyGradient {
    ...
    public characters(value: string) {
        ...
        this._fontManager.validateCharacters(value);
        this.palette.setColors(this._fontManager.glyphColors(value));
    }
