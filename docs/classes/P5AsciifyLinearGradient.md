...
[p5.asciify-pattern-renderer-plugin](../README.md) / P5AsciifyLinearGradient

# Class: P5AsciifyLinearGradient

Defined in: [renderer/gradients/linear/Linear.ts:9](https://github.com/humanbydefinition/p5.asciify-pattern-renderer-plugin/blob/78587b3ed9c9440a400d453e44e7d55e63d8c70c/src/plugin/renderer/gradients/linear/Linear.ts#L9)
...
> **new P5AsciifyLinearGradient**(`p`, `_fontManager`, `_shader`, `_characters`, `brightnessStart`, `brightnessEnd`, `params`): `P5AsciifyLinearGradient`

Defined in: [renderer/gradients/linear/Linear.ts:15](https://github.com/humanbydefinition/p5.asciify-pattern-renderer-plugin/blob/78587b3ed9c9440a400d453e44e7d55e63d8c70c/src/plugin/renderer/gradients/linear/Linear.ts#L15)
...
| ------ | ------ | ------ | ------ |
| <a id="angle"></a> `angle` | `public` | `number` | [renderer/gradients/linear/Linear.ts:11](https://github.com/humanbydefinition/p5.asciify-pattern-renderer-plugin/blob/78587b3ed9c9440a400d453e44e7d55e63d8c70c/src/plugin/renderer/gradients/linear/Linear.ts#L11) |
| <a id="direction"></a> `direction` | `public` | `number` | [renderer/gradients/linear/Linear.ts:10](https://github.com/humanbydefinition/p5.asciify-pattern-renderer-plugin/blob/78587b3ed9c9440a400d453e44e7d55e63d8c70c/src/plugin/renderer/gradients/linear/Linear.ts#L10) |
| <a id="speed"></a> `speed` | `public` | `number` | [renderer/gradients/linear/Linear.ts:12](https://github.com/humanbydefinition/p5.asciify-pattern-renderer-plugin/blob/78587b3ed9c9440a400d453e44e7d55e63d8c70c/src/plugin/renderer/gradients/linear/Linear.ts#L12) |
| <a id="zigzag"></a> `zigzag` | `public` | `boolean` | [renderer/gradients/linear/Linear.ts:13](https://github.com/humanbydefinition/p5.asciify-pattern-renderer-plugin/blob/78587b3ed9c9440a400d453e44e7d55e63d8c70c/src/plugin/renderer/gradients/linear/Linear.ts#L13) |
...
Defined in: [renderer/gradients/linear/Linear.ts:31](https://github.com/humanbydefinition/p5.asciify-pattern-renderer-plugin/blob/78587b3ed9c9440a400d453e44e7d55e63d8c70c/src/plugin/renderer/gradients/linear/Linear.ts#L31)
